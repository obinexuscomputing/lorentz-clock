...
})(GeolocationErrorType || (GeolocationErrorType = {}));
...
let GeolocationService = class GeolocationService {
    ...
    handleGeolocationError(error) {
        ...
        return new GeolocationServiceError(GeolocationErrorType.POSITION_UNAVAILABLE, 'Unknown geolocation error', error instanceof Error ? error : undefined);
    }
};
GeolocationService = __decorate([
    injectable(),
    __param(0, inject(TYPES.LocationTransformService)),
    __metadata("design:paramtypes", [Object])
], GeolocationService);

let LocationTransformService = class LocationTransformService {
    constructor() {
...
LocationTransformService = __decorate([
    injectable()
], LocationTransformService);

let GeoUtilsService = class GeoUtilsService {
    constructor() {
...
export { ContainerProvider, GeoUtilsService, GeolocationErrorType, GeolocationService, GeolocationServiceError, LocationTransformService, Physics, SPEED_OF_LIGHT, TYPES, calculateLorentzFactor, calculateProperTime, calculateSimultaneousEvents, calculateTimeDifference, calculateTimeDilation, container, isValidVelocity, synchronizeClocks };
//# sourceMappingURL=lorentz-clock.esm.js.map
